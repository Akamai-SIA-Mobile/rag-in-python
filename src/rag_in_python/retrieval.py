...
class HybridRetriever:
    ...
    def retrieve(
        ...
        **kwargs: Any,
        ...
        RetrievalDebugger.print_retrieval_summary(query, retrieved_nodes, similarity_threshold)
        ...
        for i, node_with_score in enumerate(retrieved_nodes):
            ...
            if score >= similarity_threshold:
                logger.info(
                    ...
                    f"Text length={len(node_with_score.node.text)} chars"
                )
        ...
        accepted_count, filtered_count = RetrievalDebugger.print_filtering_results(retrieved_nodes, similarity_threshold)
        RetrievalDebugger.print_final_summary(accepted_count, filtered_count, len(retrieved_nodes))
    ...
    def test_query_variations(
        ...
        for query in query_variations:
            ...
            try:
                ...
                if documents:
                    ...
                    print(f"✅ Found {len(documents)} documents, best score: {max_score:.4f}")
        ...
        if best_query:
            ...
            print(f"❌ No queries returned results above threshold {similarity_threshold}")
            print(f"💡 RECOMMENDATIONS:")
            print(f"   1. Lower the similarity threshold (try 0.05 or 0.01)")
            print(f"   2. Add documents about '{base_topic}' to your vector store")
            print(f"   3. Check if your documents use different terminology")
        print(f"{'='*80}\n")